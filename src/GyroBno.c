...
int main(int argc, char **argv) {
   ...
   uint16_t interval = 0;
   int16_t opt;
   uint8_t prod_id; // product id option. 
   ...
   // Report ID 0x2A is integrated gyro produces both rotation vector and ang velocity... just what
   // we want 5000 -> 200 hz 2500 -> 400 1250 -> 800
